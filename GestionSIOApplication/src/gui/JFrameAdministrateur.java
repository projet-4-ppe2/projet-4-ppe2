 ...
 * @author maxen
 */
public class JFrameAdministrateur extends javax.swing.JFrame {

    /**
     * Creates new form JFrameEtudiant
     */
    public JFrameAdministrateur() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameAdministrateur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameAdministrateur().setVisible(true);
            }
        });
    }
