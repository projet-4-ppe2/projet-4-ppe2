...
public class Jdbc {
     ...
     */
    private Jdbc(String protocole, String serveur, String base, String login, String mdp) {
    ...
    public static Jdbc creer(String protocole, String serveur, String base, String login, String mdp) {
        if (singleton == null) {
            singleton = new Jdbc(protocole, serveur, base, login, mdp);
        }
        return singleton;
    }
...
//        Class.forName(this.getPiloteJdbc());
        connexion = DriverManager.getConnection(this.getProtocoleJdbc() + this.getServeurBd() + this.getNomBd(), this.getLoginSgbd(), this.getMdpSgbd());
